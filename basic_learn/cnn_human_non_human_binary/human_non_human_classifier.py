...
train_path = "./human_and_non_human/training_set/training_set"
test_path = "./human_and_non_human/test_set/test_set"

#%%Export Image Dataset
# Dataset is Borrowed From Kaggle Human vs Non-Human Dataset
#Link: Get it from Onedrive

train_img_x, train_img_y, test_img_x, test_img_y=dl.load_image()


#%% Flatten the image : Incase only passed to FC Layers
...
# train_generator = train_datagen.flow(train_img_x,
#                                      train_img_y,
#                                      batch_size=32)

# test_generator = train_datagen.flow(test_img_x,
#                                     test_img_y,
#                                     batch_size=32)

train_generator = train_datagen.flow_from_directory(train_path,target_size=(50,50),batch_size=32,class_mode='binary', color_mode='grayscale')
test_generator = test_datagen.flow_from_directory(test_path,target_size=(50,50),batch_size=32,class_mode='binary', color_mode='grayscale')

# 0 - For Humans and 1- Non-Humans
